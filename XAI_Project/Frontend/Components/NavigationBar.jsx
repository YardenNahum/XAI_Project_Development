...
/**
 * Navbar component that displays logo and domain navigation.
 * StudySteps (Help Guide) is positioned on the opposite side of the domains.
 */
const Navbar = () => {
  ...
  return (
    <header className="bg-white border-b border-slate-200 shadow-sm sticky top-0 z-50">
      <div className="max-w-[1600px] mx-auto px-4 py-3 flex flex-col gap-4">
        ...
        {/* Bottom Row: Domains (Left) and Help (Right) */}
        <div className="flex items-center justify-between pt-2 border-t border-slate-50">
          ...
          {/* Right Side: Help Center Button (StudySteps) */}
